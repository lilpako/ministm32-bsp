/**
  ...
  * 27-June-2011
  * modified by Brian 
  * to support miniSTM32 board (USE_MINISTM32)
  ******************************************************************************
  * @file    stm32_eval.h
...
#elif defined USE_MINISTM32
 #include "stm32f10x.h"
 #include "miniSTM32/miniSTM32.h"
 #ifdef USE_MINISTM32_SIO
   #include "miniSTM32/miniSTM32_sio.h"
 #endif
#else 
