/**
  ******************************************************************************
  * Brian 04-Jule-2011
  *		Some bugs are fixed, BSP files are changed.
  * Brian 29-June-2011
  * 	ST EXTI_Config sample is modified for miniSTM32 BSP test.
  * 	EXTI15 is hooked up to PB15 to control LED1(PB5).
  * 	others are commented out.
  *		For a useful demonstration, you may need button debouncing algorithm
  ******************************************************************************
...
int main(void)
{
  ...
  STM_EVAL_PBInit(BUTTON_PB15, BUTTON_MODE_EXTI);
  /*
...
#if 0 /* Brian */
/**
  * @brief  Configure PB.15 in interrupt mode
  * @param  None
  * @retval None
  */
void EXTI0_Config(void)
{
  ...
  /* Connect EXTI0 Line to PB.15 pin */
